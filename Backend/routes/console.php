...
Artisan::command('hajjmart:verify-seed', function (): int {
    ...
    $checks = [
        ...
        ['Operational roles', \App\Models\Role::whereIn('slug', ['store_manager', 'sales_order_operator', 'inventory_manager'])->count(), 3],
        ...
        ['Seeded transactions', \App\Models\BusinessTransaction::where('transaction_number', 'like', 'TXN-HM-%')->count(), 200],
