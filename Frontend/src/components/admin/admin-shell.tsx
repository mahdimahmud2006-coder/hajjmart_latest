...
const moreRoutes = ["/admin/more", "/admin/social-commerce", "/admin/returns", "/admin/promotions", "/admin/delivery-charge", "/admin/stores", "/admin/employees", "/admin/reports", "/admin/activity", "/admin/offline-operations"];
