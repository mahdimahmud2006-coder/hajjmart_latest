    ...
    <div className="flex flex-col gap-6 p-4 bg-[#FFFDF8] rounded-[12px] border border-[#DDD6C7]">
      ...
      <div className="flex flex-col gap-2">
        ...
        <label className="flex items-center gap-3 cursor-pointer py-1.5 min-h-[44px]">
          ...
          />
          <span className="text-[18px] text-[#1A1A1A] select-none font-medium">
        ...
        <div className="flex flex-col gap-2 border-t border-[#DDD6C7] pt-4">
          ...
          <div className="flex flex-col gap-1 lg:max-h-[240px] lg:overflow-y-auto lg:pe-2">
            <button
              ...
              className={`w-full text-left px-3 py-2 text-[18px] rounded-[6px] transition-colors ${
            ...
            {categories.map((cat) => (
              <button
                ...
                className={`w-full text-left px-3 py-2 text-[18px] rounded-[6px] transition-colors flex items-center justify-between ${
              ...
              >
                ...
                {cat.products_count !== undefined && (
                  <span className="text-[14px] text-[#5B5650]">({cat.products_count})</span>
                )}
              </button>
            ))}
          </div>
    ...
    <>
      ...
      {isOpenMobile && (
        <div className="fixed inset-x-0 top-0 bottom-[60px] z-50 flex flex-col justify-end lg:hidden">
          ...
          />
          <div className="relative w-full max-h-[85vh] bg-[#FFFDF8] rounded-t-[16px] shadow-2xl flex flex-col z-50 overflow-hidden">
