...
export type AdminOrder = { id: number; order_number: string; order_id?: string; source_channel: string; price_mode?: "retail" | "wholesale"; source_reference?: string | null; status: string; payment_status: string; payment_method?: string; checkout_name?: string | null; checkout_mobile_number?: string | null; checkout_email?: string | null; checkout_full_address?: string | null; checkout_district?: string | null; grand_total: string | number; paid_amount?: string | number; due_amount?: string | number; shipping_total?: string | number; discount_total?: string | number; order_date?: string | null; created_at?: string; invoice_printed_at?: string | null; pathao_consignment_id?: string | null; is_potential_fraud?: boolean; fraud_score?: number; fraud_reasons?: string[]; fraud_checked_at?: string | null; customer_note?: string | null; admin_note?: string | null; delivery_status?: string | null; shop?: AdminStore | null; creator?: { id: number; name: string } | null; assignee?: { id: number; name: string } | null; packed_by?: number | null; packer?: { id: number; name: string } | null; items: AdminOrderItem[]; payments?: AdminPayment[]; return_requests?: AdminReturn[]; status_history?: AdminOrderStatusHistory[] };
export type AdminPromotion = { id: number; code?: string | null; title?: string | null; description?: string | null; type: "fixed" | "percent"; value: string | number; visibility: "public" | "private"; promotion_type: "coupon" | "public_sale"; applicable_to?: "all" | "product" | "category"; included_product_ids?: number[] | null; included_category_ids?: number[] | null; is_active?: boolean; auto_apply?: boolean; starts_at?: string | null; expires_at?: string | null; used_count?: number; usage_limit?: number | null; min_order_amount?: string | number | null };
